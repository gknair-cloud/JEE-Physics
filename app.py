...
SYLLABUS = {
    "⚛️ Physics": ["Units & Dimensions", "Kinematics", "Laws of Motion", "Work Energy and power", "Rotational Motion", "Gravitation", "Properties of Solids and Liquids", "Thermodynamics","Kinetic Theory of Gases","Oscillations and Waves", "Electrostatics", "Current Electricity","Magnetic Effects of Current and Magnetism", "Electromagnetic Induction and Alternating Currents","Electromagnetic Waves", "Optics", "Dual Nature of Matter and Radiation", "Atoms and Nuclei", "Electronic Devices"],
    "🧪 Chemistry": ["Some Basic Concepts in Chemistry","Chemical Bonding and Molecular Structure", "Atomic Structure","Chemical Thermodynamics","Solutions","Equilibrium","Redox Reactions and Electrochemistry","Chemical Kinetics", "Classification of Elements and Periodicity in Properties","p-Block Elements","d- and f- Block Elements","Coordination Compounds","Purification and Characterisation of Organic Compound", "Some basic Principles of Organic Chemistry", "Hydrocarbons", "Organic Compounds containing Halogens, Oxygen, Nitrogen"],
